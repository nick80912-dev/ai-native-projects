...
const saveSource=mod.__saveSource||fs.readFileSync('shell/v111/index.html','utf8').slice(
  fs.readFileSync('shell/v111/index.html','utf8').indexOf('function saveShoppingForm('),
  fs.readFileSync('shell/v111/index.html','utf8').indexOf('function deleteShoppingItem(')
);
...
const ui=fs.readFileSync('shell/v111/index.html','utf8');
