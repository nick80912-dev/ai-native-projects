...
(function(){
  ...
  assert.deepStrictEqual(Array.from(notes.slice(1),function(note){return note.version;}),['v135','v134','v133','v132']);
  ...
  /* v127 的「已處理」措辭說明已於 2026-09-24 隨 v132 加入而滾出五筆視窗,同前一個處理。
  /* v128 的決策鈕截斷說明已於 2026-09-24 隨 v133 加入而滾出五筆視窗,同前一個處理。
  /* v129 的串點卡片用詞說明已於 2026-09-24 隨 v134 加入而滾出五筆視窗,同前一個處理。
  /* v130 的鍵盤焦點說明已於 2026-09-24 隨 v135 加入而滾出五筆視窗,同前一個處理。
  /* v131 的交通 chip 換行說明已於 2026-09-24 隨 v136 加入而滾出五筆視窗,同前一個處理。
