...
assert.strictEqual(schemaSandbox.SCHEMA.version,'2.8 (2026-07-19)','production Schema version identifies the Ledger 2.2 contract');
...
assert.match(htmlSource,/version:\s*'2\.8 \(2026-07-19\)'/,'inline fallback Schema version identifies the Ledger 2.2 contract');
