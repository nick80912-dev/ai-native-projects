...
assert.strictEqual(schemaSandbox.SCHEMA.version,'2.3 (2026-07-16)','production Schema version identifies the Fuel contract change');
...
assert.match(htmlSource,/version:\s*'2\.3 \(2026-07-16\)'/,'inline fallback Schema version identifies the Fuel contract change');
