...
assert.match(serviceWorker, /var CACHE_NAME = 'okayama-trip-v18';/, 'service worker cache is exactly v18');
assert.doesNotMatch(serviceWorker, /okayama-trip-v16/, 'retired v16 cache is not retained');
