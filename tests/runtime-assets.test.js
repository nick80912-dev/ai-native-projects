...
assert(realInventory.assets.includes(shellPath('builtin-snapshot.js')),'the runtime inventory includes the generated BUILTIN asset');
assert(indexHtml.includes('<script src="'+shellPath('builtin-snapshot.js')+'"></script>'),'current document loads the generated BUILTIN asset');
assert(swSource.includes("'./"+shellPath('builtin-snapshot.js')+"'"),'the offline shell includes the generated BUILTIN asset');
