...
## 📌 現況
- Ledger 2.2.5 手機回饋精修已實作：完整紀錄選取時 batch 預設收合並可點卡展開；日期／時間採同列內縮 A 方案；多品項代購採 A 精修版、單品項代購採 B 開關，兩者共用既有代購 state 與 renderer。Service Worker cache 已由 v27 順延至 v28。
