...
## ⏸ 等 Bar 動作
1. **（優先）累積真機驗收 SW v58–v68**：除既有 v64–v67 項目外，新增驗證 v68 的採買多品項個人↔團體切軌資訊保留、站點內必買置頂、深層新增／編輯 Sheet 返回，以及「儲存並新增」後 iPhone Safari／PWA 鍵盤保持開啟且游標位於品名。並驗證 PWA 更新後的本機資料保留。注意需自多工列滑除 App 後重開兩次才會換到新 SW。
