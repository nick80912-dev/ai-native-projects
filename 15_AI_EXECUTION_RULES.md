...
**禁改清單硬停規則**:任務執行中若發現需修改當批 prompt 禁改清單內之任何檔案(含「改了結果會更好」的情況),必須**立即停止該子項並回報 Bar 裁定**,不得先行實作。先斬後奏即使技術結果正確,仍屬治理違規,須記入 `07_CHANGELOG.md`。
...
- 動工前確認輸出中,執行 AI 須明示已知悉 §4 禁改清單硬停規則。
