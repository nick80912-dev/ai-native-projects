...
- Schema 升至 `2.8 (2026-07-19)`；Ledger 固定契約由 16 欄擴為 21 欄，末端新增輸入幣別、免稅品、價格方式、稅率與優惠券金額。Apps Script 維護來源同步為相容舊 payload 的 21 欄 append adapter；Sheet 表頭與 Apps Script 真實部署待 Bar 依維護文件完成。
