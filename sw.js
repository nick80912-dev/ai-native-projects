/* ===== sw.js — App 外殼離線防線 =====
   ...
   1. 只管同源 App Shell；root index／app-version 是 frozen v110 bridge，current version-bearing assets 在 shell/v121/
...
var CURRENT_DOCUMENT='./shell/v121/index.html';
var CURRENT_APP_VERSION='./shell/v121/app-version.js';
var CURRENT_BUILTIN='./shell/v121/builtin-snapshot.js';
var SHELL = [
  './shell/v121/index.html',
  './shell/v121/app-version.js',
  './shell/v121/builtin-snapshot.js',
