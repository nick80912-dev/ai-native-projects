...
- `shell/v127/index.html` / `shell/v127/app-version.js` — v114 不可變文件與 App runtime 版本來源；成功啟用的 `sw.js` 才接管 root 導覽
- `shell/v127/builtin-snapshot.js` — 由刷新工具產生的版本綁定離線資料資產；禁止手動修改
